<div class="row">
    <div class="col-md-12">
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" name="first_name" id="first_name" value="{{ request()->old('first_name', $contact->first_name) }}" class="form-control  @error('first_name') is-invalid @enderror">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                ...
                @else
                <div class="text-muted">Enter the Last Name</div>
                @enderror
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                ...
                @else
                <div class="text-muted">Enter Phone</div>
                @enderror
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                ...
                @else
                <div class="text-muted">Enter Company ID</div>
                @enderror
